      ...
      xAxes: [{
        ...
        ticks: {
          ...
          callback: function(value, index, values) {
            return number_format(value) + time_type;
          }
        }
      }],
      yAxes: [{
...
var myLineChart2 = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      ...
      borderDash: [5, 5],
      pointRadius: 3,
      pointBackgroundColor: "rgba(223, 15, 13, 1)",
      pointBorderColor: "rgba(223, 15, 13, 1)",
      pointHoverRadius: 3,
      pointHoverBackgroundColor: "rgba(223, 15, 13, 1)",
      pointHoverBorderColor: "rgba(223, 15, 13, 1)",
      pointHitRadius: 10,
      pointBorderWidth: 2,
      data: predictedData,
    }
  ...
  options: {
    ...
    scales: {
      ...
      yAxes: [{
        ticks: {
          ...
          // Include a dollar sign in the ticks
          callback: function(value, index, values) {
            return rev_states[number_format(value)];
          }
        },
        gridLines: {
          color: "rgb(234, 236, 244)",
    ...
    tooltips: {
      ...
      callbacks: {
        label: function(tooltipItem, chart) {
          var datasetLabel = chart.datasets[tooltipItem.datasetIndex].label || '';
          return datasetLabel + ':' + rev_states[number_format(tooltipItem.yLabel)];
        }
      }
    }
  }
